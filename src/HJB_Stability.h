...
struct DBNode
{
  ...
  {
    SelfIndex = -1;
    NextNodeIndex = -2;           // -2 means has not been initialized, -1 means no next node, >0 gives node index of the next node.
  ...
  int NextNodeIndex;            // The index of the next node it should go according to the principle of optimality
  int ThetaViableFlag;
